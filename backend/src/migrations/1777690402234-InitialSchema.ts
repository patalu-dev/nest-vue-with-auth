...
export class InitialSchema1777690402234 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`username\` varchar(50) NOT NULL, \`email\` varchar(100) NULL, \`password\` varchar(255) NOT NULL, \`refreshToken\` varchar(255) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, UNIQUE INDEX \`IDX_c4dd678058708647766157c6e4\` (\`email\`, \`deletedAt\`), UNIQUE INDEX \`IDX_a1e512e754ab75371cea3cb659\` (\`username\`, \`deletedAt\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
